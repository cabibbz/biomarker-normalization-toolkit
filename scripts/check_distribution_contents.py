...
def _check_sdist(dist_dir: Path, version: str) -> None:
    ...
    required = {
        ...
        f"{root}/examples/custom_aliases/custom_aliases.json",
        f"{root}/examples/custom_aliases/use_custom_aliases.py",
        f"{root}/examples/fhir_ingest/normalize_bundle.py",
        f"{root}/examples/python_sdk/basic_normalize.py",
        f"{root}/examples/rest_api/curl_examples.md",
