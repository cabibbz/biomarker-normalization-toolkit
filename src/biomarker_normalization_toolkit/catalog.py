...
BIOMARKER_CATALOG: dict[str, BiomarkerDefinition] = {
    ...
    "total_cholesterol": BiomarkerDefinition(
        ...
        normalized_unit="mg/dL",
        allowed_specimens=_BLOOD,
        aliases=("Total Cholesterol", "Cholesterol", "Cholesterol, Total", "Cholesterol Total", "CHOL TOTAL",
                 "Chol", "TCHOL", "TC",
    ...
    "tsh": BiomarkerDefinition(
        ...
        aliases=("TSH", "Thyroid Stimulating Hormone", "Thyrotropin",
                 "TSH, 3rd Generation", "TSH 3rd Generation", "TSH, Ultrasensitive",
    ...
    "iron": BiomarkerDefinition(
        ...
        allowed_specimens=_BLOOD,
        aliases=("Iron", "Serum Iron", "Fe", "Iron, Total", "Iron,Total", "Total Iron",
    ...
    "ck_mb": BiomarkerDefinition(
        ...
        normalized_unit="ng/mL",
        allowed_specimens=_BLOOD,
        aliases=("CK-MB", "Creatine Kinase, MB Isoenzyme", "CK MB", "CKMB", "CPK-MB"),
    ),
    # --- Wave 6: Cardiac ---
    ...
    "pco2": BiomarkerDefinition(
        ...
        allowed_specimens=_BLOOD,
        aliases=("pCO2", "PCO2", "paCO2", "Carbon Dioxide Partial Pressure",
    ...
    "po2": BiomarkerDefinition(
        ...
        normalized_unit="mmHg",
        allowed_specimens=_BLOOD,
        aliases=("pO2", "PO2", "paO2", "Oxygen Partial Pressure",
    ...
    "bun_creatinine_ratio": BiomarkerDefinition(
        ...
        normalized_unit="ratio",
        allowed_specimens=_BLOOD,
        aliases=("BUN/Creatinine Ratio", "BUN/Creat Ratio", "BUN Creatinine Ratio",
    ...
    "estradiol": BiomarkerDefinition(
        ...
        normalized_unit="pg/mL",
        allowed_specimens=_BLOOD,
        aliases=("Estradiol", "E2", "Estradiol Ultrasensitive", "Estradiol, Ultrasensitive",
                 "17-beta Estradiol",
    ...
    "non_hdl_cholesterol": BiomarkerDefinition(
        ...
        normalized_unit="mg/dL",
        allowed_specimens=_BLOOD,
        aliases=("Non-HDL Cholesterol", "Non HDL Cholesterol", "Non-HDL Chol",
    ...
    "psa": BiomarkerDefinition(
        ...
        normalized_unit="ng/mL",
        allowed_specimens=_BLOOD,
        aliases=("PSA", "PSA Total", "Prostate Specific Antigen", "PSA, Total",
    ...
    "il6": BiomarkerDefinition(
        ...
        normalized_unit="pg/mL",
        allowed_specimens=_BLOOD,
        aliases=("IL-6", "Interleukin 6", "Interleukin-6",
    ...
    "tnf_alpha": BiomarkerDefinition(
        ...
        normalized_unit="pg/mL",
        allowed_specimens=_BLOOD,
        aliases=("TNF-alpha", "TNF alpha", "Tumor Necrosis Factor alpha",
    ...
    "cortisol_free": BiomarkerDefinition(
        ...
        normalized_unit="ug/dL",
        allowed_specimens=_BLOOD,
        aliases=("Free Cortisol", "Cortisol Free", "Cortisol, Free"),
    ),
    ...
    "beta2_microglobulin": BiomarkerDefinition(
        ...
        normalized_unit="mg/L",
        allowed_specimens=_BLOOD,
        aliases=("Beta-2 Microglobulin", "B2M", "Beta 2 Microglobulin"),
    ),
    "ca125": BiomarkerDefinition(
        ...
        normalized_unit="U/mL",
        allowed_specimens=_BLOOD,
        aliases=("CA-125", "CA 125", "Cancer Antigen 125"),
    ),
