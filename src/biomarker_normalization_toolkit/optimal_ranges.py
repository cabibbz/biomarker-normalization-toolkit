...
OPTIMAL_RANGES: dict[str, tuple[Decimal, Decimal, str, str]] = {
    ...
    "cd3_pct": (Decimal("60"), Decimal("85"), "%", "Typical adult total T-cell fraction"),
    ...
    "protein_creatinine_ratio": (Decimal("0"), Decimal("0.2"), "ratio", "< 0.2 normal"),
    "albumin_ascites": (Decimal("0"), Decimal("1.5"), "g/dL", "Context dependent; commonly low in uncomplicated ascites"),
    "glucose_ascites": (Decimal("70"), Decimal("110"), "mg/dL", "Often near serum glucose; low values suggest complicated ascites"),
    "total_protein_ascites": (Decimal("0"), Decimal("2.5"), "g/dL", "Context dependent; low values are common in portal hypertensive ascites"),
    "albumin_pleural": (Decimal("0"), Decimal("2.0"), "g/dL", "Context dependent; lower values are more typical of transudative effusions"),
    "glucose_pleural": (Decimal("70"), Decimal("110"), "mg/dL", "Usually near serum glucose unless infection, malignancy, or rheumatoid pleuritis is present"),
    "total_protein_pleural": (Decimal("0"), Decimal("3.0"), "g/dL", "Context dependent; lower values are more typical of transudative effusions"),
    # Thyroid
    ...
    "rbc_ascites": (Decimal("0"), Decimal("0"), "#/uL", "Normally absent"),
    "rbc_csf": (Decimal("0"), Decimal("0"), "#/uL", "Normally absent"),
    "rbc_pleural": (Decimal("0"), Decimal("0"), "#/uL", "Normally absent"),
    "lithium": (Decimal("0.6"), Decimal("1.2"), "mmol/L", "Typical therapeutic serum range"),
    "gentamicin": (Decimal("0.5"), Decimal("2"), "ug/mL", "Typical trough target; random levels are context dependent"),
    "carbamazepine": (Decimal("4"), Decimal("12"), "ug/mL", "Typical therapeutic serum range"),
    "theophylline": (Decimal("10"), Decimal("20"), "ug/mL", "Typical therapeutic serum range"),
    # NMR LipoProfile
