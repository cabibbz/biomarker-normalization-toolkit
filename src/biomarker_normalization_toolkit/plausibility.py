...
PLAUSIBILITY_RANGES: dict[str, tuple[Decimal, Decimal]] = {
    ...
    "carbamazepine":    (Decimal("0"),    Decimal("100")),
    ...
    "base_deficit":     (Decimal("0"),    Decimal("30")),
    "oxygen_saturation":(Decimal("20"),   Decimal("100")),
    "oxyhemoglobin":    (Decimal("20"),   Decimal("100")),
    ...
    "prealbumin":       (Decimal("1"),   Decimal("100")),
    "cortisol":         (Decimal("0.1"), Decimal("100")),
    "esr":              (Decimal("0"),   Decimal("150")),
    "osmolality_serum": (Decimal("200"), Decimal("400")),
    "lithium":          (Decimal("0"),   Decimal("10")),
    "gentamicin":       (Decimal("0"),   Decimal("50")),
    "theophylline":     (Decimal("0"),   Decimal("100")),
    "albumin_urine":    (Decimal("0"),   Decimal("5000")),
    "albumin_creatinine_ratio": (Decimal("0"), Decimal("10000")),
    "protein_creatinine_ratio": (Decimal("0"), Decimal("20")),
    "albumin_ascites":  (Decimal("0"),   Decimal("10")),
    "glucose_ascites":  (Decimal("0"),   Decimal("1000")),
    "total_protein_ascites": (Decimal("0"), Decimal("10")),
    "total_nucleated_cells_ascites": (Decimal("0"), Decimal("500000")),
    "neutrophils_ascites_pct": (Decimal("0"), Decimal("100")),
    "lymphocytes_ascites_pct": (Decimal("0"), Decimal("100")),
    "monocytes_ascites_pct": (Decimal("0"), Decimal("100")),
    "eosinophils_ascites_pct": (Decimal("0"), Decimal("100")),
    "monocytes_macrophages_ascites_pct": (Decimal("0"), Decimal("100")),
    "mesothelial_cells_ascites_pct": (Decimal("0"), Decimal("100")),
    "wbc_csf":          (Decimal("0"), Decimal("500000")),
    "albumin_pleural":  (Decimal("0"),   Decimal("10")),
    "glucose_pleural":  (Decimal("0"),   Decimal("1000")),
    "total_protein_pleural": (Decimal("0"), Decimal("10")),
    "total_nucleated_cells_pleural": (Decimal("0"), Decimal("500000")),
    "neutrophils_pleural_pct": (Decimal("0"), Decimal("100")),
    "lymphocytes_pleural_pct": (Decimal("0"), Decimal("100")),
    "eosinophils_pleural_pct": (Decimal("0"), Decimal("100")),
    "monocytes_macrophages_pleural_pct": (Decimal("0"), Decimal("100")),
    "wbc_body_fluid":   (Decimal("0"), Decimal("500000")),
    "protein_csf":      (Decimal("0"),   Decimal("1000")),
    "total_nucleated_cells_csf": (Decimal("0"), Decimal("500000")),
    "neutrophils_csf_pct": (Decimal("0"), Decimal("100")),
    "monocytes_csf_pct": (Decimal("0"), Decimal("100")),
    "macrophages_csf_pct": (Decimal("0"), Decimal("100")),
    ...
    "rbc_ascites":          (Decimal("0"),    Decimal("500000")),
    "rbc_csf":              (Decimal("0"),    Decimal("500000")),
    "rbc_pleural":          (Decimal("0"),    Decimal("500000")),
    "neutrophils_body_fluid_pct": (Decimal("0"), Decimal("100")),
    "lymphocytes_body_fluid_pct": (Decimal("0"), Decimal("100")),
    "eosinophils_body_fluid_pct": (Decimal("0"), Decimal("100")),
    "monocytes_macrophages_body_fluid_pct": (Decimal("0"), Decimal("100")),
    "macrophages_body_fluid_pct": (Decimal("0"), Decimal("100")),
    ...
    "ige_peanut":           (Decimal("0"),    Decimal("5000")),
    "ige_walnut":           (Decimal("0"),    Decimal("5000")),
    "ige_codfish":          (Decimal("0"),    Decimal("5000")),
    "ige_shrimp":           (Decimal("0"),    Decimal("5000")),
    "ige_wheat":            (Decimal("0"),    Decimal("5000")),
    "ige_egg_white":        (Decimal("0"),    Decimal("5000")),
    "ige_soybean":          (Decimal("0"),    Decimal("5000")),
    "ige_cow_milk":         (Decimal("0"),    Decimal("5000")),
    "ige_white_oak":        (Decimal("0"),    Decimal("5000")),
    "ige_common_ragweed":   (Decimal("0"),    Decimal("5000")),
    "ige_cat_dander":       (Decimal("0"),    Decimal("5000")),
    "ige_american_house_dust_mite": (Decimal("0"), Decimal("5000")),
    "ige_cladosporium_herbarum": (Decimal("0"), Decimal("5000")),
    "ige_honey_bee":        (Decimal("0"),    Decimal("5000")),
    "ige_latex":            (Decimal("0"),    Decimal("5000")),
