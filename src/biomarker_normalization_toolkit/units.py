...
CONVERSION_TO_NORMALIZED: dict[str, dict[str, Decimal]] = {
    ...
    "lithium": {"mmol/L": Decimal("1")},
    "gentamicin": {"ug/mL": Decimal("1"), "mg/L": Decimal("1")},
    "carbamazepine": {"ug/mL": Decimal("1"), "mg/L": Decimal("1")},
    "theophylline": {"ug/mL": Decimal("1"), "mg/L": Decimal("1")},
    ...
    "glucose_urine_presence": {"": Decimal("1")},
    "urine_protein_presence": {"": Decimal("1")},
    "urine_ketones_presence": {"": Decimal("1")},
    "urine_bilirubin_presence": {"": Decimal("1")},
    ...
    "rbc_ascites": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "rbc_csf": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "rbc_pleural": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    ...
    "protein_creatinine_ratio": {"ratio": Decimal("1"), "mg/mg": Decimal("1"), "mg/g": Decimal("0.001")},
    "albumin_ascites": {"g/dL": Decimal("1"), "g/L": Decimal("0.1")},
    "glucose_ascites": {"mg/dL": Decimal("1"), "mmol/L": Decimal("18")},
    "total_protein_ascites": {"g/dL": Decimal("1"), "g/L": Decimal("0.1")},
    "total_nucleated_cells_ascites": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "neutrophils_ascites_pct": {"%": Decimal("1")},
    "lymphocytes_ascites_pct": {"%": Decimal("1")},
    "monocytes_ascites_pct": {"%": Decimal("1")},
    "eosinophils_ascites_pct": {"%": Decimal("1")},
    "monocytes_macrophages_ascites_pct": {"%": Decimal("1")},
    "mesothelial_cells_ascites_pct": {"%": Decimal("1")},
    "wbc_csf": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "total_nucleated_cells_csf": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "neutrophils_csf_pct": {"%": Decimal("1")},
    "monocytes_csf_pct": {"%": Decimal("1")},
    "macrophages_csf_pct": {"%": Decimal("1")},
    "albumin_pleural": {"g/dL": Decimal("1"), "g/L": Decimal("0.1")},
    "glucose_pleural": {"mg/dL": Decimal("1"), "mmol/L": Decimal("18")},
    "total_protein_pleural": {"g/dL": Decimal("1"), "g/L": Decimal("0.1")},
    "total_nucleated_cells_pleural": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "neutrophils_pleural_pct": {"%": Decimal("1")},
    "lymphocytes_pleural_pct": {"%": Decimal("1")},
    "eosinophils_pleural_pct": {"%": Decimal("1")},
    "monocytes_macrophages_pleural_pct": {"%": Decimal("1")},
    "wbc_body_fluid": {"#/uL": Decimal("1"), "K/uL": Decimal("1000")},
    "neutrophils_body_fluid_pct": {"%": Decimal("1")},
    "lymphocytes_body_fluid_pct": {"%": Decimal("1")},
    "eosinophils_body_fluid_pct": {"%": Decimal("1")},
    "monocytes_macrophages_body_fluid_pct": {"%": Decimal("1")},
    "macrophages_body_fluid_pct": {"%": Decimal("1")},
    "total_protein_urine": {"mg/dL": Decimal("1"), "mg/L": Decimal("0.1")},
    "total_protein_urine_24h": {"mg/24h": Decimal("1"), "g/24h": Decimal("1000")},
    ...
    "ige_peanut": {"IU/mL": Decimal("1")},
    "ige_walnut": {"IU/mL": Decimal("1")},
    "ige_codfish": {"IU/mL": Decimal("1")},
    "ige_shrimp": {"IU/mL": Decimal("1")},
    "ige_wheat": {"IU/mL": Decimal("1")},
    "ige_egg_white": {"IU/mL": Decimal("1")},
    "ige_soybean": {"IU/mL": Decimal("1")},
    "ige_cow_milk": {"IU/mL": Decimal("1")},
    "ige_white_oak": {"IU/mL": Decimal("1")},
    "ige_common_ragweed": {"IU/mL": Decimal("1")},
    "ige_cat_dander": {"IU/mL": Decimal("1")},
    "ige_american_house_dust_mite": {"IU/mL": Decimal("1")},
    "ige_cladosporium_herbarum": {"IU/mL": Decimal("1")},
    "ige_honey_bee": {"IU/mL": Decimal("1")},
    "ige_latex": {"IU/mL": Decimal("1")},
    # --- Wave 13: Niche ---
